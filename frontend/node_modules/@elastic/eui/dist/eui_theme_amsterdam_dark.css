...
.euiComboBoxOption__contentWrapper {
  ...
  .euiComboBoxOption__contentWrapper .euiComboBoxOption__enterBadge {
    ...
    margin-left: 4px; }
    .euiComboBoxOption__contentWrapper .euiComboBoxOption__enterBadge span {
      display: -webkit-box;
      display: -ms-flexbox;
      display: flex;
      -webkit-box-align: center;
...
.euiProgress__data {
  ...
  -webkit-box-pack: justify;
      -ms-flex-pack: justify;
          justify-content: space-between; }
  .euiProgress__data .euiProgress__label {
    max-width: 100%;
    overflow: hidden !important;
    text-overflow: ellipsis !important;
    white-space: nowrap !important;
    ...
    -webkit-box-flex: 1;
        -ms-flex-positive: 1;
            flex-grow: 1; }
  .euiProgress__data .euiProgress__valueText {
    max-width: 100%;
    overflow: hidden !important;
    text-overflow: ellipsis !important;
    white-space: nowrap !important;
...
.euiHeaderBreadcrumbs {
  ...
  .euiHeaderBreadcrumbs .euiBreadcrumb {
    ...
    .euiHeaderBreadcrumbs .euiBreadcrumb:enabled:hover, .euiHeaderBreadcrumbs .euiBreadcrumb:enabled:focus {
      background-color: rgba(223, 229, 239, 0.35); }
    .euiHeaderBreadcrumbs .euiBreadcrumb.euiBreadcrumb--collapsed, .euiHeaderBreadcrumbs .euiBreadcrumb.euiLink {
      color: #429cff;
      background-color: rgba(35, 140, 255, 0.2); }
      .euiHeaderBreadcrumbs .euiBreadcrumb.euiBreadcrumb--collapsed:enabled:hover, .euiHeaderBreadcrumbs .euiBreadcrumb.euiBreadcrumb--collapsed:enabled:focus, .euiHeaderBreadcrumbs .euiBreadcrumb.euiLink:enabled:hover, .euiHeaderBreadcrumbs .euiBreadcrumb.euiLink:enabled:focus {
        background-color: rgba(35, 140, 255, 0.35); }
