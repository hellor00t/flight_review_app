...
declare module '@elastic/eui' {
	...
	export { useCombinedRefs, useDependentState } from '@elastic/eui/src/services/hooks';
...
declare module '@elastic/eui/src/components/button/button' {
	...
	} const EuiButtonDisplay: React.ForwardRefExoticComponent<EuiButtonDisplayProps & React.RefAttributes<HTMLElement>>;
	export { EuiButtonDisplay }; type EuiButtonPropsForAnchor = PropsForAnchor<EuiButtonProps, {
...
declare module '@elastic/eui/src/components/avatar/avatar' {
	...
	export const checkValidColor: (color: string | undefined) => void;
	export {};
...
declare module '@elastic/eui/src/components/button/button_empty/button_empty' {
	...
	export const FLUSH_TYPES: import ("@elastic/eui/src/components/button/button_content").ButtonContentIconSide[];
	/**
	 * Extends EuiButtonContentProps which provides
	 * `iconType`, `iconSide`, and `textProps`
	 */
...
declare module '@elastic/eui/src/components/context/context' {
	...
	export interface I18nShape {
	    ...
	    locale?: string;
	} const I18nContext: React.Context<I18nShape>; const EuiI18nConsumer: React.Consumer<I18nShape>;
...
declare module '@elastic/eui/src/components/progress/progress' {
	import { FunctionComponent, HTMLAttributes, ProgressHTMLAttributes, ReactNode } from 'react';
...
declare module '@elastic/eui/src/components/form/range/dual_range' {
	...
	export class EuiDualRange extends Component<EuiDualRangeProps> {
	    ...
	    get isValid(): boolean;
	    _determineInvalidThumbMovement: (newVal: string | number, lower: string | number, upper: string | number, e: React.KeyboardEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement, MouseEvent> | React.ChangeEvent<HTMLInputElement>) => void;
	    ...
	    _handleOnChange: (lower: string | number, upper: string | number, e: React.KeyboardEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement, MouseEvent> | React.ChangeEvent<HTMLInputElement>) => void;
	    ...
	    _handleKeyDown: (value: string | number, event: React.KeyboardEvent<HTMLInputElement>) => number;
...
declare module '@elastic/eui/src/components/table/utils' {
	...
	export const resolveWidthAsStyle: (style?: CSSProperties, width?: string | number | undefined) => {
	    ...
	    appearance?: "button" | "meter" | "textarea" | "unset" | "none" | "inherit" | "initial" | "listbox" | "-moz-initial" | "revert" | "radio" | "checkbox" | "button-bevel" | "menulist" | "menulist-button" | "progress-bar" | "push-button" | "searchfield" | "slider-horizontal" | "square-button" | "textfield" | undefined;
	    ...
	    userSelect?: "unset" | "text" | "none" | "auto" | "inherit" | "initial" | "all" | "element" | "-moz-initial" | "revert" | "contain" | "-moz-none" | undefined;
	    ...
	    MozUserSelect?: "unset" | "text" | "none" | "auto" | "inherit" | "initial" | "all" | "element" | "-moz-initial" | "revert" | "contain" | "-moz-none" | undefined;
	    ...
	    msUserSelect?: "unset" | "text" | "none" | "inherit" | "initial" | "element" | "-moz-initial" | "revert" | undefined;
	    ...
	    WebkitUserSelect?: "unset" | "text" | "none" | "auto" | "inherit" | "initial" | "all" | "element" | "-moz-initial" | "revert" | "contain" | "-moz-none" | undefined;
	    ...
	    boxLines?: "unset" | "inherit" | "initial" | "-moz-initial" | "revert" | "single" | "multiple" | undefined;
	    ...
	    KhtmlBoxLines?: "unset" | "inherit" | "initial" | "-moz-initial" | "revert" | "single" | "multiple" | undefined;
	    ...
	    KhtmlUserSelect?: "unset" | "text" | "none" | "auto" | "inherit" | "initial" | "all" | "element" | "-moz-initial" | "revert" | "contain" | "-moz-none" | undefined;
	    ...
	    WebkitBoxLines?: "unset" | "inherit" | "initial" | "-moz-initial" | "revert" | "single" | "multiple" | undefined;
...
declare module '@elastic/eui/src/services/breakpoint' {
	 ...
	 */
	export function getBreakpoint(width: number, breakpoints?: EuiBreakpoints): string | undefined;
...
declare module '@elastic/eui/src/components/card/card' {
	...
	export const DISPLAYS: CardDisplay[]; type CardPaddingSize = 'none' | 's' | 'm' | 'l';
	...
	export const SIZES: import ("@elastic/eui").PanelPaddingSize[];
...
declare module '@elastic/eui/src/components/code/_code_block' {
	import { FunctionComponent } from 'react';
	import { FontSize, PaddingSize } from '@elastic/eui/src/components/code/code_block';
...
declare module '@elastic/eui/src/components/control_bar/control_bar' {
	import React, { ButtonHTMLAttributes, Component, HTMLAttributes, MouseEventHandler, Ref } from 'react';
...
declare module '@elastic/eui/src/components/facet/facet_group' {
	...
	export const GUTTER_SIZES: import ("@elastic/eui").PanelPaddingSize[];
...
declare module '@elastic/eui/src/components/page/page_body/page_body' {
	...
	export const EuiPageBody: <T extends ComponentType>({ children, restrictWidth, style, className, component: Component, ...rest }: React.PropsWithChildren<EuiPageBodyProps<T>>) => JSX.Element;
	export {};
...
declare module '@elastic/eui/src/components/resizable_container/context' {
	...
	export class EuiResizablePanelRegistry {
	    ...
	    registerResizerRef(resizerRef: HTMLElement): void;
	    deregisterResizerRef(resizerRef: HTMLElement): void;
...
declare module '@elastic/eui/src/components/resizable_container/resizable_button' {
	import React, { FunctionComponent, ButtonHTMLAttributes, KeyboardEvent, MouseEvent, TouchEvent } from 'react';
	import { CommonProps } from '@elastic/eui/src/components/common';
...
declare module '@elastic/eui/src/components/resizable_container/helpers' {
	...
	export const useContainerCallbacks: ({ isHorizontal, state, setState, containerRef, registryRef, onPanelWidthChange, }: Params) => {
	    ...
	    onKeyDown: (event: EuiResizableButtonKeyDownEvent) => void;
...
declare module '@elastic/eui/src/components/selectable/selectable_option' {
	...
	export interface EuiSelectableLIOption extends EuiSelectableOptionBase, ButtonHTMLAttributes<HTMLLIElement> {
	}
	export type EuiSelectableOption = ExclusiveUnion<EuiSelectableGroupLabelOption, EuiSelectableLIOption>;

}
declare module '@elastic/eui/src/components/selectable/matching_options' {
	export const getMatchingOptions: (options: ((import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption))[], searchValue: string, isPreFiltered?: boolean | undefined, selectedOptions?: ((import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption))[] | undefined) => ((import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption))[];
...
declare module '@elastic/eui/src/components/selectable/selectable_search/selectable_search' {
	...
	export type EuiSelectableSearchProps = Omit<EuiFieldSearchProps, 'onChange'> & CommonProps & {
	    /**
...
declare module '@elastic/eui/src/components/selectable/selectable_list/selectable_list' {
	...
	export class EuiSelectableList extends Component<EuiSelectableListProps> {
	    ...
	    ListRow: React.MemoExoticComponent<({ data, index, style }: ListChildComponentProps) => JSX.Element>;
	    render(): JSX.Element;
	    onAddOrRemoveOption: (option: (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption)) => void;
	    private onAddOption;
...
declare module '@elastic/eui/src/components/selectable/selectable' {
	...
	export class EuiSelectable extends Component<EuiSelectableProps, EuiSelectableState> {
	    ...
	    static getDerivedStateFromProps(nextProps: EuiSelectableProps, prevState: EuiSelectableState): {
	        visibleOptions: ((import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption))[];
	    ...
	    onKeyDown: (event: React.KeyboardEvent<HTMLDivElement>) => void;
	    incrementActiveOptionIndex: (amount: number) => void;
	    onSearchChange: (visibleOptions: ((import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption))[], searchValue: string) => void;
	    onContainerBlur: () => void;
	    onOptionClick: (options: ((import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption) | (import ("@elastic/eui/src/components/common").DisambiguateSet<import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableLIOption, import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption> & import ("@elastic/eui/src/components/selectable/selectable_option").EuiSelectableGroupLabelOption))[]) => void;
	    render(): JSX.Element;
	}
	export {};
...
declare module '@elastic/eui/src/components/tree_view/tree_view' {
	...
	export class EuiTreeView extends Component<EuiTreeViewProps, EuiTreeViewState> {
	    ...
	    onKeyDown: (event: React.KeyboardEvent<Element>, node: Node) => void;
	    onChildrenKeydown: (event: React.KeyboardEvent<Element>, index: number) => void;
	    render(): JSX.Element;
	}
	export {};
...
declare module '@elastic/eui/src-docs/src/views/breadcrumbs/props' {
	import { FunctionComponent } from 'react';
	import { EuiBreadcrumb, EuiBreadcrumbResponsiveMaxCount } from '@elastic/eui';
	export const BreadcrumbResponsiveMaxCount: FunctionComponent<EuiBreadcrumbResponsiveMaxCount>;
	export const BreadcrumbProps: FunctionComponent<EuiBreadcrumb>;
...
declare module '@elastic/eui/src-docs/src/views/header/header_stacked' {
	 const _default: () => JSX.Element;
	export default _default;
...
declare module '@elastic/eui/src-docs/src/views/text_diff/props' {
	import { FunctionComponent } from 'react';
	import { EuiTextDiffProps } from '@elastic/eui';
