...
function (_Component) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onSearchChange", function (value) {
      if (value !== _this.state.searchValue) {
        _this.setState({
          ...
          var matchingOptions = (0, _matching_options.getMatchingOptions)(_this.props.options, value);
  ...
  (0, _createClass2.default)(EuiSelectableSearch, [{
    ...
    value: function componentDidMount() {
      ...
      var matchingOptions = (0, _matching_options.getMatchingOptions)(this.props.options, searchValue);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props, ["className", "onChange", "options", "defaultValue", "listId", "placeholder"]);
