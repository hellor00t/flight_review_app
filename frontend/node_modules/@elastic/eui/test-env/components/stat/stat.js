...
var EuiStat = function EuiStat(_ref) {
  ...
  }, (0, _react.createElement)(descriptionElement, commonProps, description));
  ...
  var titleDisplay = isColorClass(titleColor) ? _react.default.createElement(_title.EuiTitle, {
    size: titleSize,
    className: titleClasses
  }, (0, _react.createElement)(titleElement, commonProps, titleChildren)) : _react.default.createElement(_title.EuiTitle, {
    size: titleSize,
    className: titleClasses
  }, (0, _react.createElement)(titleElement, titlePropsWithColor, titleChildren));
  ...
  var statDisplay = _react.default.createElement(_react.Fragment, null, !reverse && descriptionDisplay, titleDisplay, reverse && descriptionDisplay, typeof title === 'string' && typeof description === 'string' && screenReader);
