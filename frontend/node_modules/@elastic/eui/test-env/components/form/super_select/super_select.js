...
function (_Component) {
  ...
  function EuiSuperSelect() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setButtonRef", function (popoverButtonRef) {
      if (popoverButtonRef) {
        _this.buttonRef = popoverButtonRef.querySelector('button');
      } else {
