  ...
  var onKeyDown = (0, _react.useCallback)(function (event) {
    ...
    if ((shouldResizeHorizontalPanel || shouldResizeVerticalPanel) && prevPanelId && nextPanelId) {
      ...
      if (onPanelWidthChange) {
        ...
        onPanelWidthChange(_objectSpread({}, panelObject, (_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, prevPanelId, prevPanelSize), (0, _defineProperty2.default)(_objectSpread2, nextPanelId, nextPanelSize), _objectSpread2)));
      }
    ...
    if (state.isDragging && state.previousPanelId && state.nextPanelId) {
      ...
      if (prevPanelSize >= prevPanelMin && nextPanelSize >= nextPanelMin) {
        if (onPanelWidthChange) {
          ...
          onPanelWidthChange(_objectSpread({}, panelObject, (_objectSpread3 = {}, (0, _defineProperty2.default)(_objectSpread3, state.previousPanelId, prevPanelSize), (0, _defineProperty2.default)(_objectSpread3, state.nextPanelId, nextPanelSize), _objectSpread3)));
        }
