...
var EuiColorPicker = function EuiColorPicker(_ref) {
  ...
  var inlineInput = secondaryInputDisplay !== 'none' && _react.default.createElement(_i18n.EuiI18n, {
  ...
  var composite = _react.default.createElement(_react.default.Fragment, null, secondaryInputDisplay === 'top' && _react.default.createElement(_react.default.Fragment, null, inlineInput, _react.default.createElement(_spacer.EuiSpacer, {
    size: "s"
  ...
  })), showSwatches && _react.default.createElement(_flex.EuiFlexGroup, {
    wrap: true,
    responsive: false,
    gutterSize: "s",
    role: "listbox"
  ...
  })), secondaryInputDisplay === 'bottom' && _react.default.createElement(_react.default.Fragment, null, mode !== 'picker' && _react.default.createElement(_spacer.EuiSpacer, {
    size: "s"
  }), inlineInput), showAlpha && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_spacer.EuiSpacer, {
    size: "s"
  }), _react.default.createElement(_i18n.EuiI18n, {
    token: "euiColorPicker.alphaLabel",
    default: "Alpha channel (opacity) value"
  }, function (alphaLabel) {
    return _react.default.createElement(_form.EuiRange, {
