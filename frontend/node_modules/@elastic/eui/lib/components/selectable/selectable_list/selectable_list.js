...
function (_Component) {
  ...
  function EuiSelectableList(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "ListRow", (0, _react.memo)(function (_ref) {
      var data = _ref.data,
          index = _ref.index,
          style = _ref.style;
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", _extends({
        ...
        var width = _ref3.width,
            height = _ref3.height;
        return _react.default.createElement(_reactWindow.FixedSizeList, _extends({
