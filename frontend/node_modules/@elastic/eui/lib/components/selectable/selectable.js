...
function (_Component) {
  ...
  function EuiSelectable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "optionsListRef", (0, _react.createRef)());
  ...
  _createClass(EuiSelectable, [{
    ...
    value: function render() {
      ...
      var search = searchable ? _react.default.createElement(_i18n.EuiI18n, {
        ...
        return _react.default.createElement(_selectable_search.EuiSelectableSearch, _extends({
          key: "listSearch",
          options: options,
      ...
      var list = messageContent ? _react.default.createElement(_selectable_message.EuiSelectableMessage, {
        ...
        return _react.default.createElement(_selectable_list.EuiSelectableList, _extends({
          key: "list",
          options: options,
          visibleOptions: visibleOptions,
          searchValue: searchValue,
