...
var DefaultItemAction = function DefaultItemAction(_ref) {
  ...
  if (action.type === 'icon') {
    ...
    button = _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_button.EuiButtonIcon, {
      className: className,
    ...
    }), _react.default.createElement(_accessibility2.EuiScreenReaderOnly, null, _react.default.createElement("span", {
      id: ariaLabelId
    }, actionContent)));
  } else {
