 ...
 */
var EuiButtonDisplay = _react.default.forwardRef(function (_ref, ref) {
  ...
  var innerNode = _react.default.createElement(_button_content.EuiButtonContent, _extends({
    isLoading: isLoading,
    iconType: iconType,
    iconSide: iconSide,
...
var EuiButton = function EuiButton(_ref2) {
  ...
  return _react.default.createElement(EuiButtonDisplay, _extends({
    element: element,
    ref: buttonRef
