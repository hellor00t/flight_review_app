  ...
  _createClass(EuiSelectableListItem, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["children", "className", "disabled", "checked", "isFocused", "showIcons", "prepend", "append", "allowExclusions"]);
      ...
      if (showIcons) {
        ...
        optionIcon = React.createElement(EuiIcon, {
      ...
      if (allowExclusions && checked === 'on') {
        state = React.createElement(EuiScreenReaderOnly, null, React.createElement("span", null, React.createElement(EuiI18n, {
          token: "euiSelectableListItem.includedOption",
          default: "Included option."
        })));
        instruction = React.createElement(EuiScreenReaderOnly, null, React.createElement("span", null, React.createElement(EuiI18n, {
      ...
      }, optionIcon, prependNode, React.createElement("span", {
