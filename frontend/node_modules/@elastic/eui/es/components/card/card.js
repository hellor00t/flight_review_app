...
export var EuiCard = function EuiCard(_ref) {
  ...
  var classes = classNames('euiCard', paddingSizeToClassNameMap[paddingSize], displayToClassNameMap[display], textAlignToClassNameMap[textAlign], layoutToClassNameMap[layout], {
