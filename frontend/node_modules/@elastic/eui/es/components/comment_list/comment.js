...
export var EuiComment = function EuiComment(_ref) {
  ...
  return React.createElement("div", _extends({
    className: classes
  }, rest), React.createElement(EuiCommentTimeline, {
    type: type,
    timelineIcon: timelineIcon
  }), React.createElement(EuiCommentEvent, {
    username: username,
    actions: actions,
    event: event,
    timestamp: timestamp,
