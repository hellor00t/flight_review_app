...
export var EuiButtonEmpty = function EuiButtonEmpty(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutProperties(_ref, ["children", "className", "iconType", "iconSide", "color", "size", "flush", "isDisabled", "disabled", "isLoading", "href", "target", "rel", "type", "buttonRef", "contentProps", "textProps"]);
  ...
  var innerNode = React.createElement(EuiButtonContent, _extends({
    isLoading: isLoading,
    iconType: iconType,
    iconSide: iconSide,
...
EuiButtonEmpty.__docgenInfo = {
  "description": "Extends EuiButtonContentProps which provides\n`iconType`, `iconSide`, and `textProps`",
  "methods": [],
