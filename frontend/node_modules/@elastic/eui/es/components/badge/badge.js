...
export var EuiBadge = function EuiBadge(_ref) {
  ...
  if (iconOnClick) {
    return onClick || href ? React.createElement("span", {
      className: classes,
    ...
    }), optionalIcon)) : React.createElement(EuiInnerText, null, function (ref, innerText) {
    ...
    return React.createElement(EuiInnerText, null, function (ref, innerText) {
      return React.createElement(Element, _extends({
        ...
        ref: ref,
        title: innerText
      }, relObj, rest), React.createElement("span", {
        className: "euiBadge__content"
      }, React.createElement("span", {
        className: "euiBadge__text"
      }, children), optionalIcon));
